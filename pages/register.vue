<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-zinc-950">
    <div class="max-w-md w-full space-y-8 p-8 bg-white dark:bg-zinc-900 rounded-lg shadow">
      <div>
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-zinc-100">注册</h2>
      </div>
            ...
            <FormItem>
              <FormControl>
                <Input v-model="formData.email" type="email" placeholder="邮箱" required
                  class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 placeholder-gray-500 dark:placeholder-zinc-500 text-gray-900 dark:text-zinc-100 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm" />
              </FormControl>
            </FormItem>
          </FormField>
