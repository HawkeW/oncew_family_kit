<template>
  <div class="text-foreground">
    <h1 class="text-lg font-medium mb-6">便便记录</h1>

    <!-- 添加记录表单 -->
    <div class="bg-card rounded-lg p-4 mb-6">
      <h2 class="text-lg font-medium mb-4">添加新记录</h2>
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex space-x-2">
          <Button
            variant="outline"
            size="sm"
            :class="{ 'bg-primary/20 border-primary': dataType === 'user' }"
          ...
          <Button
            variant="outline"
            size="sm"
            :class="{ 'bg-primary/20 border-primary': dataType === 'all' }"
          ...
          <Button
            variant="outline"
            size="sm"
            :class="{ 'bg-primary/20 border-primary': dataType === 'group' }"
