...
RUN corepack prepare pnpm@9 --activate && pnpm config set manage-package-manager-versions true
...
# Disable devtools to avoid unstorage dependency issue during build
